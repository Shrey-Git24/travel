...
const Data = [
  {
    ...
    fees: "$700",
    description:
      "The epitome of romance, Bora Bora is a beautiful destination. This place is known for its luxurious stays and adventurous activities.",
  },
  {
    id: 2,
    imgSrc: img2,
  ...
  },
  {
    ...
    fees: "$500",
    description:
      "Bali is an Indonesian Island and one of the best holiday destination in the Indonesian archipelago. Bali is known for its volcanic mountains, history, art & culture, food, temples and beautiful sandy beaches.",
  },
];
